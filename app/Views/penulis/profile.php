                ...
                <div class="table-responsive">
                  <table class="table">
                    <tbody>
                      <tr>  
                        <th>ID</th>
                        <td><?=$penulis->idpenulis?></td>
                      </tr>
                      <tr>  
                        <th>Nama </th>
                        <td><?=ucfirst($penulis->nama_penulis)?></td>
                      </tr>
                      <tr>  
                        <th>Email</th>
                        <td><?=$penulis->email?></td>
                      ...
                      <tr>  
                        <td colspan="2">
                          <a href="<?=base_url('penulis/edit_profile')?>" class="btn btn-primary mt-2">
                            Edit Profile
                          </a>
                          <a href="<?=base_url('penulis/update_password')?>" class="btn btn-info mt-2">
                            Change Password
                          </a>
                        </td>
                      </tr>
