                      ...
                      <table class="table" id="data">
                        ...
                        <tbody>
                          ...
                          if($row->status == 'request'){
                            ...
                            echo '<td><a class="btn btn-info btn-sm" href="#" data-toggle="modal" data-target="#konfirmReset'.$row->idrequest.'" title="Kirim email pemulihan password">Reset<i class="mdi mdi-backup-restore ml-2"></i></a></td>';
                          echo '</tr>';
                          } else{
                          ...
                          <div class="modal fade" id="konfirmReset<?=$row->idrequest?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
